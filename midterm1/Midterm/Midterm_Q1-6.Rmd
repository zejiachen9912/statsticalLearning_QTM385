...
Since Random Forest has the best test set performance, we will use it as our Big Predictive Model.
...
```{r}
lasso.select <- rownames(lasso.importance)[2:6] 
